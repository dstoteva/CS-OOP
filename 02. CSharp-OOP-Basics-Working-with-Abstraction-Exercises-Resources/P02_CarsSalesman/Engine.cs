...
namespace P02_CarsSalesman
{
    public class Engine
    {
        ...
        public Engine(string model, int power) : this(model, power, -1, efficiencyValue)
        {
        }

        public Engine(string model, int power, int displacement) : this(model, power, displacement, efficiencyValue)
        {
        }
